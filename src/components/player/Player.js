                        ...
                        <ul className="play-schedule-list" id="play-schedule-list">
                            {
                                playing.map((v, i) => (
                                    <li className="play-schedule-program" id={`program-${i}`} key={v.s}>
                                        <h4 className="play-schedule-program__title">{v.s}</h4>
                                        <div className="play-schedule-program__details">
                                            <div className="play-schedule-program__time">
                                                <em className="play-schedule-program__time-text">{v.t}</em>
                                            </div>
                                            <div className="play-schedule-program__description">
                                                <strong className="play-schedule-program__album">{v.r}</strong>
